        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <Reveal variant="up" className="lg:col-span-5">
            ...
            <div className="mt-10 space-y-4 text-sm">
              <a href="https://wa.me/919123808384" data-cursor="Chat" className="block rounded-2xl border border-border p-5 hover:border-foreground transition-colors">
                <div className="text-xs text-muted-foreground uppercase tracking-widest">WhatsApp</div>
                <div className="text-lg font-bold mt-1">+91 91238 08384</div>
              </a>
              <a href="tel:+919123808384" className="block rounded-2xl border border-border p-5 hover:border-foreground transition-colors">
